...
const UserTable = () => {
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-2 sm:px-4 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:pb-11">
            {/* Add member button */}
            ...
            {/* Table section */}
            <div className="overflow-x-auto rounded-lg border border-stroke shadow-sm">
                {/* Desktop Table View */}
                    ...
                    <table className="w-full table-auto text-sm text-left">
                        <thead className="bg-gray-50 dark:bg-boxdark text-gray-600 font-medium border-b">
                            <tr>
                                ...
                                <th className="py-3 px-6 dark-text">Account Status</th>
                                ...
                                <div key={idx} className="bg-white dark:bg-boxdark rounded-xl shadow-sm overflow-hidden">
                                    ...
                                    <div className="p-4 bg-color-custom-top from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700">
                                        <div className="flex items-center gap-4">
                                            <div className="w-14 h-14 rounded-full overflow-hidden bg-white shadow-md ring-2 ring-white">
                                                {item.profile_photo ? (
                                                    <NextImage
                                                        src={`/api${item.profile_photo}`}
                                                        alt="Profile"
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-1">
                                                    <span>{capitalizeFirstLetter(item.name)}</span>
                                                    <span>{capitalizeFirstLetter(item.lastname)}</span>
                                                </h3>
                                                <p className="text-gray-600 dark:text-gray-300">{item.email}</p>
                                                <p className="text-sm font-medium mt-1 dark:text-white">{item.phonenumber}</p>
                                            </div>
                                        </div>
                                    </div>
