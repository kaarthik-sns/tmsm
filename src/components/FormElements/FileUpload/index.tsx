const FileUpload = ({ name, handleChange }) => {
    return (
        <div>
            ...
            <div
                id={`FileUpload-${name}`}
                className="relative w-full cursor-pointer rounded-lg border border-dashed border-gray-400 bg-gray-100 px-6 py-5 text-center transition-all hover:border-primary hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600"
            >
                <input
                    type="file"
