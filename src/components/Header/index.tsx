        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          {session?.user.is_admin ? (
            ...
            session?.user.name ? (
              ...
              <button className="btn-login" onClick={() => router.push("/admin/auth/signin")}>Login</button>
            )
          ) : (
            ...
            <>
              {!session?.user.name && (
                <>
                  <button className="btn-login" onClick={() => router.push("/auth/signin")}>Login</button>
                  <button className="btn-signup"onClick={() => router.push("/auth/signup")}>Signup</button>
                </>
              )}
              {session?.user.name && <button className="btn-logout" onClick={() => signOut()}>Logout</button>}
            </>
          )}
        </div>
      </div>
