...
const Elements = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-boxdark-2 p-4 sm:p-6 lg:p-8 flex items-center justify-center">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="flex-shrink-0">
                    <div 
                      className={`relative w-[250px] h-[250px] rounded-full overflow-hidden cursor-pointer ${
                        isDragging ? 'border-primary bg-primary/5' : preview ? 'bg-gray-100' : 'bg-gray-50'
                      } ${
                        formErrors.preview
