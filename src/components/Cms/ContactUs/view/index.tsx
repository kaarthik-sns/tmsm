...
const TermTable = () => {
    ...
    const fetchTableItems = async () => {
        try {
            const response = await axios.post("/api/cms/contact-us/view");
    ...
    const handleEdit = () => {
        router.push(`/admin/cms/contact-us/edit`);
    };

    return (
        <>
            <Breadcrumb pageName={isTamil ? 'மின்னஞ்சல் தரவு' : 'Contact Us Email Template'} />
                ...
                <div className="">
                    <div>
                        <div className="mt-3 md:mt-0">
                            ...
                            >
                                {isTamil ? "மின்னஞ்சலைத் திருத்து" : "Edit Contact Us Email"}
                            </button>
                        </div>
                    </div>
                </div>
