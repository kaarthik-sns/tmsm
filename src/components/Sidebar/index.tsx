  ...
  const menuGroups = [
    {
      ...
      menuItems: [
        ...
        },
        {
          ...
          label: isTamil ? 'உறுப்பினர்கள்' : 'Users',
          route: "#",
          children: [
...

        {
          ...
          label: isTamil ? 'விண்ணப்பம்' : 'Profile Request',
        ...
        },
        {
          ...
          label: isTamil ? "உள்ளடக்கம்" : "CMS",
          route: "#",
          children: [
            { label: isTamil ? "முகப்பு பக்கம்" : "Home", route: "/admin/cms/home/page/view" },
            { label: isTamil ? "ஸ்லைடர்" : "Slider", route: "/admin/cms/home/slider/list" },
            { label: isTamil ? "சான்றுரை" : "Testimonials", route: "/admin/cms/home/testimonial/list" },
            { label: isTamil ? "விமர்சனங்கள்" : "Reviews", route: "/admin/cms/home/review/list" },
            { label: isTamil ? "எங்களை பற்றி" : "About", route: "/admin/cms/about/view" },
            { label: isTamil ? "கேள்விகள்" : "Faq", route: "/admin/cms/faq/list" },
            { label: isTamil ? "விதிகள்" : "Terms", route: "/admin/cms/terms_conditions/view" },
            { label: isTamil ? "தனியுரிமை" : "Privacy Policy", route: "/admin/cms/privacy-policy/view" },
            { label: isTamil ? "திரும்ப பெறுதல்" : "Refund Policy", route: "/admin/cms/refund-policy/view" },
            { label: isTamil ? "தொடர்பு மின்னஞ்சல்" : "Contact Us Mail Template", route: "/admin/cms/contact-us/view" },
          ],
        ...
        },
        {
          ...
          label: isTamil ? "தொடர்புக்கு" : "Contact",
