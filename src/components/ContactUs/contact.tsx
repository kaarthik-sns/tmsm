                ...
                <table className="w-full table-auto text-md text-left">
                    <thead className="text-gray-600 font-medium border-b">
                        <tr>
                            ...
                            <th className="hidden sm:table-cell py-3 px-4 sm:px-6 dark-text">Email</th>
                            <th className="hidden sm:table-cell py-3 px-4 sm:px-6 dark-text">Phone</th>
                            <th className="hidden sm:table-cell py-3 px-4 sm:px-6 dark-text">Message</th>
                            <th className="py-3 px-4 sm:px-6 dark-text">Actions</th>
                        </tr>
                    </thead>
