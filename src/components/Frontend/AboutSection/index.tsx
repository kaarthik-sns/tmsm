  ...
  const features = [
    {
      ...
      title: lang === 'ta' ? homeData.feature_one_ta : homeData.feature_one,
    },
    {
      icon: homeData.feature_two_img,
      title: lang === 'ta' ? homeData.feature_two_ta : homeData.feature_two,
    },
    {
      icon: homeData.feature_three_img,
      title: lang === 'ta' ? homeData.feature_three_ta : homeData.feature_three,
    },
    {
      icon: homeData.feature_four_img,
      title: lang === 'ta' ? homeData.feature_four_ta : homeData.feature_four,
    },
  ];
          ...
          <section className="relative bg-[#FFD16C] py-12">
            ...
            <div className="container mx-auto px-6 py-6 md:py-12">
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                ...
                {/* Text Section */}
                <div className="w-full md:w-1/2 md:text-left py-6 md:py-12 description">
                  <h2 className="heading mb-4 md:mb-6">{homeData.sec_one_title_ta}</h2>
                  <div dangerouslySetInnerHTML={{ __html: homeData.sec_one_desc_ta }} />
                </div>
              </div>
            </div>
          ...
          <section className="relative bg-[#F8F8F8] py-6 md:py-12">
            <div className="container mx-auto px-6">
              <div className="flex flex-col-reverse md:flex-row items-center gap-4 md:gap-8">
                {/* Text Section */}
                <div className="w-full md:w-1/2 md:text-left py-6 md:py-12 description">
                  <h2 className="heading mb-4 md:mb-6">{homeData.sec_two_title_ta}</h2>
                  <div dangerouslySetInnerHTML={{ __html: homeData.sec_two_desc_ta }} />
                </div>
                {/* Image Section */}
                <div className="w-full md:w-1/2 py-6 md:py-12">
                  <div className="relative w-full h-[300px] md:h-[600px] overflow-hidden border-0">
