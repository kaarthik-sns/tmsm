...
import Home_page_slider from '@/models/Home_page_slider';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const newRecord = new Home_page_slider({ title, description, image });
...
export async function PUT(request: NextRequest) {
    try {
        ...
        const updatedRecord = await Home_page_slider.findByIdAndUpdate(id, Fields, { new: true });
...
export async function GET(request: NextRequest) {
    try {
        ...
        const record = await Home_page_slider.findById(id);
...
export async function PATCH(req: NextRequest) {
    ...
    try {
        ...
        await connectToDatabase();
        const dataModel = await Home_page_slider.getById(id);
