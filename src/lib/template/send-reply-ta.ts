    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" class="container">
          ...
          <tr>
            <td align="left">
              <h1>உங்கள் தொடர்புக்கு நன்றி!</h1>
              <h2>அன்பான ${name},</h2>
              <p>நீங்கள் எங்களை தொடர்பு கொண்டதற்கு நன்றி. உங்கள் செய்தியை பெற்றோம்.</p>
              <p>இது உங்கள் கேள்விக்கு எங்களுடைய பதில்:</p>
              ...
              <p style="margin-top: 30px; font-size: 12px; color: rgb(0, 0, 0);">
                ...
                <span style="color: rgb(0, 0, 0); font-size: 12px;">TMSM Hub குழுவினர்</span></i>
              </p>
