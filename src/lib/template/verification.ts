                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width: 600px; background-color: #FFF7E7; padding: 25px; border-radius: 10px; border: 2px solid #FFF7E7;">
                    ...
                    <tr>
                        <td align="left" style="padding-top: 20px;">
                            ...
                            <h2 style="color: #000000; font-size: 15px; font-weight: 400; margin-top: 1em; font-family: 'Noto Sans', sans-serif;">Hello ${user_name},</h2>

                            <p style="color: #000000; line-height: 1.8; font-size: 14px; font-family: 'Noto Sans', sans-serif;">Thank you for signing up! To complete your registration, please verify your email address.</p>
                            ...
                            <p style="color: #000000; line-height: 1.8; font-size: 14px; font-family: 'Noto Sans', sans-serif;">Click the<strong> "Verify Email" </strong>button below to confirm your email address.</p>

                            <p style="text-align: center; margin: 20px 0;">
                                <a href="${verification_link}" style="display: inline-block; background: linear-gradient(135deg, #FFB347, #FFD16C); color: #653D27 !important; text-decoration: none; padding: 12px 24px; border-radius: 30px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);">
                                    Verify Email
                                </a>
                            </p>    

                            <p style="color: #FF0000; font-size: 12px; font-weight: bold; font-family: 'Noto Sans', sans-serif;">
                                <i>Note: If you have any questions, please contact our support team at 
                                <a href="mailto:${email}" style="color:#000000;text-decoration:none;font-weight:bold">${email}</a>.</i>
                            </p>
