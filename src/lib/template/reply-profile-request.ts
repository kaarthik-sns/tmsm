export const replyProfileRequestTemplate = (name: string, homePage: string, content: string, copyright: string, email: string, mail_logo: string, status: string): string =>
    `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" class="container">
                    ...
                    <tr>
                        <td align="left">
                            <h1>Profile View Request Is ${status.charAt(0).toUpperCase() + status.slice(1)}!</h1>
                            <h2>Hello ${name},</h2>
                            <p>${content}</p>
