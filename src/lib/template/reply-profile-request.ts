export const replyProfileRequestTemplate = (name: string, homePage: string, content: string, copyright: string, email: string, status: string): string =>
    `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width: 600px; background-color: #FFF7E7; padding: 25px; border-radius: 10px; border: 2px solid #FFF7E7;">
                    ...
                    <tr>
                        <td align="left" style="padding-top: 20px;">
                            <h1 style="color: #6f9c5d; font-size: 18px; font-weight: 700; margin-top: 2em; font-family: 'Noto Sans', sans-serif;">Profile View Request Is ${status.charAt(0).toUpperCase() + status.slice(1)}!</h1>
                            <h2 style="color: #000000; font-size: 15px; font-weight: 400; margin-top: 1em; font-family: 'Noto Sans', sans-serif;">Hello ${name},</h2>
                            <p style="color: #000000; line-height: 1.8; font-size: 14px; font-family: 'Noto Sans', sans-serif;">${content}</p>
