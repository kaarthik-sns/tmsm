export const profileViewRequestTemplate = (recName: string, sentName: string, homePage: string, copyright: string, mail_logo: string, email: string) : string =>
    `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" class="container">
                    ...
                    <tr>
                        <td align="left">
                            <h1>New Profile Request Awaiting Your Response!</h1>
                            <h2>Hello ${recName},</h2>
                            <p>You have received a new profile view request from <strong>${sentName}</strong>.</p>
                            <p>You can choose to <strong>Accept</strong> or <strong>Reject</strong> the request at your convenience.</p>
                            <p>Click the<strong> "Login to Respond" </strong>button below to access your account.</p>
